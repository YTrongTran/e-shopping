...
Route::prefix('/login')->group(function () {
    ...
    Route::post('/create', 'Frontend\LoginController@register')->name('frontend.register');
    Route::get('/checkemail', 'Frontend\LoginController@store')->name('frontend.login.register');
