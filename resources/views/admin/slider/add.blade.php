            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-body">
                        <form class="form-horizontal mt-4" method="POST" action="{{ route('slider.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="desc" cols="156"   rows="5" style="display: block;resize: none;"  ></textarea>
                            </div>
                            ...
                            <button type="submit" class="btn btn-outline-primary">Thêm slider</button>
