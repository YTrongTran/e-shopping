            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-body">
                        <form class="form-horizontal mt-4" method="POST" action="{{ route('setting.store') }}" enctype="multipart/form-data">
                            @csrf
                                <div class="form-group">
                                    <label>Tên key(<span class="help" style="color:red">*</span>)</label>
                                    <input type="text" class="form-control" placeholder="..." name="config_key" value="{{ old('config_key') }}">
                                </div>
                                @php
                                ...
                                <input type="hidden" name="type" value="Text">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="..." name="config_value" value="{{ old('config_value') }}">
                                    </div>
                                @elseif ($url == 'Textarea' )
                                <input type="hidden" name="type" value="Textarea">
                                    <div class="form-group">
                                        <label>Giá trị key(<span class="help" style="color:red">*</span>)</label>
                                        <textarea name="config_value" cols="156"   rows="5" style="display: block;resize: none;"  ></textarea>
                                    </div>
                                @endif

                            <button type="submit" class="btn btn-outline-primary">Thêm setting</button>
