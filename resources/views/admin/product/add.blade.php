            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-body">
                        <form class="form-horizontal mt-4" method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Nhập giá sản phẩm" name="price" value="{{ old('price') }}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
