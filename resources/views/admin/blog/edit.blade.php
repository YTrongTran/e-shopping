            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-body">
                        <form class="form-horizontal mt-4" method="POST" action="{{ route('blog.update',['id'=>$blog->id]) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label>Tên bài viết(<span class="help" style="color:red">*</span>)</label>
                                <input type="text" class="form-control" placeholder="Vietnames..." name="name" value="{{ $blog->name }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <img src="{{ asset($blog->image_path) }}" alt="ảnh đại diện" style="width: 100px; height: 100px; object-fit: cover; margin-top: 10px">
                            </div>
                            <div class="form-group">
                                <label>Mô tả bài viết(<span class="help" style="color:red">*</span>)</label>
                                <textarea name="desc" id="desc" cols="100" rows="20" style="display: block;resize: none;"  >{{ $blog->description }}</textarea>
                            </div>
